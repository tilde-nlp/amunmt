  ...
  public:
    ...
    void MakeStep(mblas::Matrix& NextState,
      ...
      if (filteredWords) {
        ...
        *filteredWords = God::GetFilter().GetFilteredVocab(newIdxs, 30000);
        softmax_.Filter(*filteredWords);
        Probs.Resize(Probs.Rows(), filteredWords->size());
      }
